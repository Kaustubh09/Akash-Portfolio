// Hero section content — drives the top-of-page intro.

export const hero = {
  eyebrow: 'SEBI Registered • INH000027450',
  greeting: '',
  ...
  stats: [
    ...
    { value: '100%', label: 'SEBI Registered' },
    { value: 'Professional ', label: 'F&O Trader' },
